...
import toc_config
import aplus_nodes
import directives.meta as aplus_meta
...
def setup(app):
    ...
    app.add_node(
        aplus_meta.aplusmeta,
        html=(aplus_meta.visit_ignore, aplus_meta.depart_ignore)
    )
    app.add_directive('aplusmeta', aplus_meta.AplusMeta)
